...
def main_app(root, username):
    ...
    def show_home():
        ...
        btn_inner_frame.pack(anchor="e", padx=20)

        tk.Button(
            btn_inner_frame,
            text="Thêm ghi chú",
            command=show_create_note,
            bg=BUTTON_BG,
            fg=BUTTON_FG,
            font=("Arial", 11, "bold"),
            width=15,
        ...
        tk.Button(
            btn_inner_frame,
            text="Sửa ghi chú",
            command=lambda: print("Chức năng sửa ghi chú"),
            bg=BUTTON_BG,
            fg=BUTTON_FG,
            font=("Arial", 11, "bold"),
            width=15,
        ...
        tk.Button(
            btn_inner_frame,
            text="Xóa ghi chú",
            command=lambda: print("Chức năng xóa ghi chú"),
            bg=BUTTON_BG,
            fg=BUTTON_FG,
            font=("Arial", 11, "bold"),
            width=15,
        ...
        search_entry = tk.Entry(
            search_frame, textvariable=search_var, width=40, font=("Arial", 12)
        )
        ...
        def display_notes(keyword=""):
            ...
            filtered_notes = [
                ...
                if (
                    keyword.lower() in note.get("title", "").lower()
            ...
            for idx, note in enumerate(filtered_notes):
                ...
                tk.Label(
                    note_frame,
                    text=note.get("title", "Không có tiêu đề"),
                    bg="#2b2b2b",
                    fg="white",
                    font=("Arial", 12, "bold"),
                    anchor="w",
                ...
                tk.Label(
                    note_frame,
                    text=f"Thời gian: {note.get('time', 'Không rõ')}",
                    bg="#2b2b2b",
                    fg="gray",
                    font=("Arial", 9),
                    anchor="w",
    ...
    def show_trash():
        ...
        tk.Label(
            content_frame,
            text="Thùng rác - Chức năng đang phát triển",
            bg=MAIN_BG,
            fg="white",
            font=("Arial", 20),
        ).pack(pady=20)
